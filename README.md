...
Smart Resume Analyzer is an AI-powered web application developed to automate resume analysis and provide intelligent career guidance.

The system extracts information from resumes, analyzes candidate profiles using Large Language Models (LLaMA 3.1 via Groq API), identifies skills, determines domain, calculates job match scores, and recommends suitable job roles.
